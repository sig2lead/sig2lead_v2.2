...
Installation/Configuration of Sig2Lead_v2.2
...
Sig2Lead and associated files can be downloaded from: https://github.com/sig2lead/sig2lead_v2.2/
...
docker pull sig2lead/sig2lead:v2_2

Linux users may need to use sudo to run Docker by typing: sudo docker pull sig2lead/sig2lead:v2_2 
...
docker run -p 3838:3838 -d sig2lead/sig2lead:v2_2
